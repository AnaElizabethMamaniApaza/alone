...
class ventaController extends Controller
{
    ...
    public function store(StoreVentaRequest $request)
    {
        try {
            ...
            $arrayCantidad = $request->get('arraycantidad'); // Cambié el nombre para claridad
            ...
            while ($cont < $siseArray) {
                ...
                $venta->productos()->syncWithoutDetaching([
                    $arrayProducto_id[$cont] => [
                        'cantidad' => $arrayCantidad[$cont],  // Esta es la cantidad de la venta
                ...
                DB::table('productos')
                    ...
                    ->update([
                        'stock' => $cantidadInventario - $cantidadVenta  // Restar la cantidad vendida
                    ]);
